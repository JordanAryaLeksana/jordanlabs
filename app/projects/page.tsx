...
export default function ProjectsPage() {
  ...
  return <main className="min-h-screen overflow-x-clip bg-[var(--bg)] text-[var(--fg)]"><CinematicPageChapter scene="projects" priority><PortfolioHeader /><FeaturedProjects projects={projects} /></CinematicPageChapter><Footer /></main>;
}
