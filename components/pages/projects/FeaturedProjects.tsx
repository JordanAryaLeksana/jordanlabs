...
export function FeaturedProjects({ projects }: FeaturedProjectsProps) {
  return (
    <Section id={PROJECT_SECTION_IDS.featured} className="min-h-[calc(100svh-8rem)] py-12 md:py-16" disableReveal>
      ...
      <StaggerContainer trigger="mount" className="grid gap-x-6 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
